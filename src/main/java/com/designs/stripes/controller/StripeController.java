package com.designs.stripes.controller;
...
import com.designs.stripes.repository.CartItemRepository;
import com.designs.stripes.repository.ProductRepository;
import com.designs.stripes.repository.ShoppingCartRepository;
import com.designs.stripes.repository.UserRepository;
...
public class StripeController {
    ...
    public String checkoutPay(HttpServletRequest request, Model model) throws StripeException {
        // Set your secret key: remember to change this to your live secret key
        // in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
    ...
    public String elementsPay(HttpServletRequest request, Model model) throws StripeException {
        // Set your secret key: remember to change this to your live secret key
        // in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
    ...
    public String paymentOrderPay(Model model) {
        // Set your secret key: remember to change this to your live secret key
        // in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
    ...
    public String subscribe(Model model, @RequestParam double total) throws StripeException {
        // Set your secret key: remember to change this to your live secret key
        // in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
    ...
    public String multiplanSubscribe(Model model) throws StripeException {
    ...
    public String discountSubscribe(Model model) throws StripeException {
        // Set your secret key: remember to change this to your live secret key in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
    ...
    public String trialSubscribe(Model model) throws StripeException {
        // Set your secret key: remember to change this to your live secret key in production
        // See your keys here: https://dashboard.stripe.com/account/apikeys
        Stripe.apiKey = "sk_test_51LVGWfEkOmr60BkQ9xxnJocpRZxRM87XMaLvn79ocyubR7VbSbOGcrjdERzuJZZb8Of8eABxIor0Q3wj9Mpitq8B005ewZKWwG";
